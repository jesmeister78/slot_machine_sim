...
<html>
	...
	<body onLoad="noBack(); fnRndAction(7, gup('bal'));" onpageshow="if (event.persisted) noBack();" onUnload="">
			...
			<table class="main_table" align="center">
				<tr> 
					<td>
						...
						<p class="begin">
							<input type="button" value="Begin Task!" onClick="doTimer('tasktime6'); show('task6');">
							<input type="hidden" name="tasktime6" id="tasktime5" value="">
						
						<div class="task_div" id="task6" style="display:none">
