...
<html>
	...
	<body onLoad="noBack(); fnRndAction(4, gup('bal'));" onpageshow="if (event.persisted) noBack();" onUnload="">
			...
			<table class="main_table" align="center">
				<tr> 
					<td>
						...
						<p class="begin">
							<input type="button" value="Begin Task!" onClick="doTimer('tasktime3'); show('task3');">
							<input type="hidden" name="tasktime3" id="tasktime3" value=""></p>
						
						<div class="task_div" id="task3" style="display:none">
