...
<html>
	...
	<body onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
		<form name="form1" method="post" action="section11.php?bal=<?php echo $_GET['bal']; ?>">
			<?php 
				include ("write_post_vals.php");
				// balance 2
				echo '<input type="hidden" name="balance2" value="' . str_replace('"',"'", $_GET['bal']) . '" />';					
			?>
			<table class="main_table" align="center">
				<tr> 
					<td width="860" height="100%" valign="top" bgcolor="#FFFFFF">
						...
						<table class="img_input_table" align="center">
							<tr class="odd_row">
								<th>
									Down/Depressed</th>
								<td>
									<input type="radio" value="-7" name="s10item2" /></td>
								<td>
									<input type="radio" value="-6" name="s10item2" /></td>
								<td>
									<input type="radio" value="-5" name="s10item2" /></td>
								<td>
									<input type="radio" value="-4" name="s10item2" /></td>
								<td>
									<input type="radio" value="-3" name="s10item2" /></td>
								<td>
									<input type="radio" value="-2" name="s10item2" /></td>
								<td>
									<input type="radio" value="-1" name="s10item2" /></td>
								<th>
									<input type="radio" value="0" name="s10item2" /><br/>Neither</th>
								<td>
									<input type="radio" value="1" name="s10item2" /></td>
								<td>
									<input type="radio" value="2" name="s10item2" /></td>
						...
						<table class="img_input_table" align="center">
							<tr class="odd_row">
								<th>
									Relaxed</th>
								<td>
									<input type="radio" value="-7" name="s10item3" /></td>
								<td>
									<input type="radio" value="-6" name="s10item3" /></td>
								<td>
									<input type="radio" value="-5" name="s10item3" /></td>
								<td>
									<input type="radio" value="-4" name="s10item3" /></td>
								<td>
									<input type="radio" value="-3" name="s10item3" /></td>
								<td>
									<input type="radio" value="-2" name="s10item3" /></td>
								<td>
									<input type="radio" value="-1" name="s10item3" /></td>
								<th>
									<input type="radio" value="0" name="s10item3" /><br/>Neither</th>
								<td>
									<input type="radio" value="1" name="s10item3" /></td>
								<td>
									<input type="radio" value="2" name="s10item3" /></td>
						...
						<p class="begin">
							<input type="submit" name="Submit" value="Continue" /></p></td></tr></table></td></tr></table></form>
	</body>
</html>
