			...
			<tr> 
				<td>
					...
					<table class="img_input_table" align="center">
						...
						<tr class="odd_row">
							<td>
								<input type="radio" value="-7" name="s18item1" /></td>
							<td>
								<input type="radio" value="-6" name="s18item1" /></td>
							<td>
								<input type="radio" value="-5" name="s18item1" /></td>
							<td>
								<input type="radio" value="-4" name="s18item1" /></td>
							<td>
								<input type="radio" value="-3" name="s18item1" /></td>
							<td>
								<input type="radio" value="-2" name="s18item1" /></td>
							<td>
								<input type="radio" value="-1" name="s18item1" /></td>
							<td>
								<input type="radio" value="0" name="s18item1" /></td>
							<td>
								<input type="radio" value="1" name="s18item1" /></td>
							<td>
								<input type="radio" value="2" name="s18item1" /></td>
							...
							<td>
								<input type="radio" value="6" name="s18item1" /></td>
							<td>
								<input type="radio" value="7" name="s18item1" /></td></tr></table>
					<br />			
					<br />	
					<p>
					...
					<form name="form1" method="post" action="section19.php?bal=<?php echo $_GET['bal']; ?>">  
						<?php 
							include ("write_post_vals.php");
							// balance 4
							echo '<input type="hidden" name="balance4" value="' . str_replace('"',"'", $_GET['bal']) . '" />';	
						?>
						<p class="begin">
