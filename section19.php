...
<html>
	...
	<body onLoad="noBack(); fnRndAction(5, gup('bal'));" onpageshow="if (event.persisted) noBack();" onUnload="">
			...
			<table class="main_table" align="center">
				<tr> 
					<td>
						...
						<p class="begin">
							<input type="button" value="Begin Task!" onClick="doTimer('tasktime4'); show('task4');">
							<input type="hidden" name="tasktime4" id="tasktime4" value=""></p>
						
						<div class="task_div" id="task4" style="display:none">
